...
class CertificateAcceptedNotification extends BaseNotification
{
    use Queueable;
    const STATE = 1;
    protected $via = [
    ...
    {
        return __('messages.certificate_request_accepted_title');
    }
    ...
    public function getBody()
    {
        ...
        return __('messages.certificate_request_accepted_body',[
